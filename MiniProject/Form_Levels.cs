...
namespace MiniProject
{
    public partial class Form_Levels : Form
    {
        ...
        private void StylizeGridView()
        {
            ...
            dataGridView_Level.Columns[0].HeaderText = "Delete";
            dataGridView_Level.Columns[1].HeaderText = "Edit";
            dataGridView_Level.Columns[3].HeaderText = "Id";
            dataGridView_Level.Columns[4].HeaderText = "Details";
            dataGridView_Level.Columns[4].HeaderText = "Measurement Level";
            // END:: NAMES
